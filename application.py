...
• Следование правилам```""",
        ...
        embed.add_field(
            name="🎯 **ПРОЦЕСС ОТБОРА:**",
            value="""```fix
1. Подача заявки (форма ниже)
2. Проверка анкеты модераторами
3. Обзвон в голосовом канале
4. Принятие решения
5. Вступление в семью```""",
            inline=False
        )
...
[Время рассмотрения]: 1-24 часа```""",
        ...
        confirm_embed = discord.Embed(
            title="✅ СИСТЕМА ЗАЯВОК НАСТРОЕНА",
            description="**Набор в семью успешно открыт!**\n\n"
                      f"**📍 Канал для заявок:** {target_channel.mention}\n"
                      f"**📋 Форма заявки:** отправлена в {interaction.channel.mention}\n"
                      f"**👮 Модерация:** доступна ролям <@&1454210800813346968> и <@&1454210803472400404>\n\n"
                      "Теперь пользователи могут подавать заявки через кнопку.",
            color=0x2ecc71
        )
        confirm_embed.set_footer(text="Ludoman clnx • Успешных наборов! 🎲")
